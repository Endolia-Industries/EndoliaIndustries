...
execute as @a[gamemode=!spectator,tag=has_conduit_power] at @s run function scp:gamemode_change
...
# Toggle
execute as @a[tag=scp_toggle,gamemode=spectator] at @s[tag=!switched_gamemode] run function scp:toggle
